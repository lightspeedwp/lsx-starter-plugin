...
function lsx_currency_api_admin_init(){
	...
	if(false !== $options && isset($options['general'])){
		if(isset($options['general']['{plugin-name}_api_key']) && '' !== $options['general']['{plugin-name}_api_key']){
			$data['api_key'] = $options['general']['{plugin-name}_api_key'];
		}
		if(isset($options['general']['{plugin-name}_email']) && '' !== $options['general']['{plugin-name}_email']){
			$data['email'] = $options['general']['{plugin-name}_email'];
		}		
	}
